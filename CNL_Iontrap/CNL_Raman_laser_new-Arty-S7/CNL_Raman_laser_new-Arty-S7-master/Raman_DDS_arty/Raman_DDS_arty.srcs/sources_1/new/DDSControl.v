...
module DDSControl
	...
	/* Divide 100MHz Clock by 8 : AD9951 can accept up to 25 MHz clock, but according to Steve's comment, 
		slightly lower clock is recommended. */
	reg SPI_clk, clkLSB2 ,clkLSB;
	always @(posedge clk100MHz)
	begin
			{SPI_clk, clkLSB2 ,clkLSB} <= {SPI_clk, clkLSB2, clkLSB} + 3'h1;  /* 3bit register, clk => MSB, clkLSB2 => second LSB ,clkLSB => LSB */
	end
