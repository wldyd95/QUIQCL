...
HD_PWD='Q:/Users/swYoo/Arty S7/lag_comp/lag_comp_v1.3.2_16bit/verilog/v1_00.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_without_capture_waveform_data.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_without_capture_waveform_data.tcl -notrace
