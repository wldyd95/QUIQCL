...
HD_PWD='Q:/Users/swYoo/Arty S7/lag_comp/lag_comp_v1.3.2_16bit/verilog/v1_00.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_without_capture_waveform_data.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_without_capture_waveform_data.tcl
